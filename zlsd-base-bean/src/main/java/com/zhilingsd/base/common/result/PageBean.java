...
public class PageBean<T> extends PageSerializable<T> {
     ...
     * @param list
     */
    public PageBean(List<T> list, Long totalNum, int pageNum, int pageSize) {
        this(list, 8, totalNum, pageNum, pageSize);
    }
    ...
    public PageBean(List<T> list, int navigatePages, Page curPage) {
        ...
        if (list instanceof Page) {
            ...
            this.pages = this.pageSize > 0 ? (int) ((this.total + this.pageSize - 1) / this.pageSize) : 0;
            this.size = list.size();
            this.startRow = 0;
            this.endRow = list.size() > 0 ? list.size() - 1 : 0;
        }
     ...
     * @param navigatePages 页码数量
     */
    public PageBean(List<T> list, int navigatePages, Long totalNum, int pageNum, int pageSize) {
        super(list);
        if (list instanceof Page) {
            Page page = (Page) list;
            this.pageNum = page.getPageNum();
