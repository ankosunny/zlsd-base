...
/**
 * Created by zhangyf18255 on 2017/7/16.
 */
public class ReflectionUtil {
     ...
     * @return
     */
    public static boolean signAnnotation(Field field, Class ant) {
        Annotation annotation = field.getAnnotation(ant);
     ...
     * @return
     */
    public static boolean signAnnotation(Method method, Class ant) {
        Annotation annotation = method.getAnnotation(ant);
        return annotation != null;
    }
    ...
    public static boolean isPropertyType(final Type type) {
        ...
        return type instanceof Class && isPropertyType(type);
    }
            ...
            if (paramType instanceof GenericArrayType) {
                ...
                if (paramType instanceof ParameterizedType) {
                    ...
                    if (paramType instanceof TypeVariable) {
                        ...
                        // from the T/V/X
                        throw new RuntimeException("Generic Typed Class not supported:  <" + ((TypeVariable) paramType).getName() + "> = "
                ...
                if (paramType instanceof GenericArrayType) {
                    ...
                    if (paramType instanceof ParameterizedType) {
                        ...
                        if (paramType instanceof TypeVariable) {
                            ...
                            // the parent class and try to get the variable type
                            // from the T/V/X
                            // throw new RuntimeException("Generic Typed Class not supported:  <" + ((TypeVariable)
