...
import com.zhilingsd.base.es.core.ElasticSearchTemplate;
import com.zhilingsd.base.es.core.ElasticSearchTemplateImpl;
...
/**
 * @className ZLElasticSearchClientConfig.java
 * @description //TODO
 * @author linmenghuai
 * @version 1.0
...
//    }
    ...
    public ElasticSearchTemplate elasticsearchTemplate(RestHighLevelClient restHighLevelClient) {
        ...
        elasticsearchTemplate.setClient(restHighLevelClient);
