...
@Configuration
@EnableSwagger2
@ConditionalOnProperty(prefix = SwaggerProperties.SWAGGER_PREFIX, name = "whether.open.version.three", havingValue = "true", matchIfMissing = false)
@EnableConfigurationProperties(SwaggerProperties.class)
public class SwaggerConfigVersionThree {

    private SwaggerProperties properties;


    public SwaggerConfigVersionThree(SwaggerProperties properties) {
